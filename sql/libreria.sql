...
CREATE TABLE IF NOT EXISTS `libreria`.`Departamento` (
  ...
  CONSTRAINT `id_pais` FOREIGN KEY (`id_pais`) REFERENCES `libreria`.`Pais` (`idPais`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `libreria`.`Ciudad` (
  ...
  CONSTRAINT `id_dpto` FOREIGN KEY (`id_dpto`) REFERENCES `libreria`.`Departamento` (`idDepartamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `libreria`.`Cliente` (
  ...
  CONSTRAINT `id_ciudad` FOREIGN KEY (`id_ciudad`) REFERENCES `libreria`.`Ciudad` (`idCiudad`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `libreria`.`Libro` (
  ...
  CONSTRAINT `id_editorial` FOREIGN KEY (`id_editorial`) REFERENCES `libreria`.`Editorial` (`idEditorial`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_dimensiones` FOREIGN KEY (`id_dimensiones`) REFERENCES `libreria`.`Dimensiones` (`idDimensiones`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `libreria`.`Pedido` (
  ...
  CONSTRAINT `id_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `libreria`.`Cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_empleado` FOREIGN KEY (`id_empleado`) REFERENCES `libreria`.`Empleado` (`idEmpleado`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `libreria`.`PedidosProveedor` (
  `idPedidosProveedor` INT NOT NULL AUTO_INCREMENT,
  `id_sucursal` INT NULL,
  `fecha` TIMESTAMP NULL,
  `total` DECIMAL(10, 2) NULL,
  ...
  CONSTRAINT `id_estado_pedidosProve` FOREIGN KEY (`id_estado`) REFERENCES `libreria`.`EstadoPedido` (`idEstadoPedido`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `libreria`.`LibroProveedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `libreria`.`LibroProveedor` (
  `id_libro` INT NULL,
  `id_proveedor` INT NULL,
  INDEX `id_libro_idx` (`id_libro` ASC),
  INDEX `id_proveedor_idx` (`id_proveedor` ASC),
  CONSTRAINT `id_libro_libroProv` FOREIGN KEY (`id_libro`) REFERENCES `libreria`.`Libro` (`idLibro`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `id_proveedor_libroProv` FOREIGN KEY (`id_proveedor`) REFERENCES `libreria`.`Proveedor` (`idProveedor`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
VALUES (
  ...
  (
    ...
    2,
    '666689',
    'info@proveedornorte.com'
  );
INSERT INTO `libreria`.`LibroProveedor` (`id_proveedor`, `id_libro`)
VALUES (1, 1),
  (1, 2),
  (2, 2),
  (2, 3),
